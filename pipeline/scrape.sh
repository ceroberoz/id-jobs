...
initialize_merged_file() {
    ...
    echo "job_title,job_location,job_department,job_url,first_seen,base_salary,job_type,job_level,job_apply_end_date,last_seen,is_active,company,company_url,job_board,job_board_url,job_age,work_arrangement" > "$MERGED_FILE"
}
